...
var letters$ = intervalSubject.pipe((0, operators_1.switchMap)(function (i) {
  return (0, rxjs_1.interval)(i).pipe((0, operators_1.scan)(function (letters) {
    return {
      intrvl: i,
      ltrs: [{
        letter: randomLetter(),
        yPos: Math.floor(Math.random() * gameWidth)
      }].concat(_toConsumableArray(letters.ltrs))
    };
  }, {
    ltrs: [],
    intrvl: 0
...
var keys$ = (0, rxjs_1.fromEvent)(document, "keydown").pipe((0, operators_1.startWith)({
  key: ""
}), (0, operators_1.map)(function (e) {
  return e.key;
}));
var renderGame = function renderGame(state) {
  return document.body.innerHTML = "Score: ".concat(state.score, ", Level: ").concat(state.level, " <br/>"), state.letters.forEach(function (l) {
...
var game$ = (0, rxjs_1.combineLatest)(keys$, letters$).pipe((0, operators_1.scan)(function (state, _ref) {
...
//# sourceMappingURL=/alphabet-invasion.77de5100.js.map